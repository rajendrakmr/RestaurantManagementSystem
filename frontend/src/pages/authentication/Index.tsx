...
const Index: React.FC = () => {
    ...
    const [formData, setFormData] = useState({ password: "password123", mobile: "9060665647" });
    const [errors, setErrors] = useState<{ password?: string; mobile?: string; apiError?: string }>({});
        ...
        try {
            ...
            if (response?.token) {
                dispatch(setCredentials({
                    ...
                    userInfo: response.employee,
                }));
                const authData = response.employee
            ...
            let apiError = "Please enter correct mobile and password.";
                    ...
                    <div className="tw-p-5 md:tw-p-6 tw-mb-4 tw-rounded-2xl tw-transition-all tw-duration-200 tw-bg-white tw-shadow-sm tw-ring-1 tw-ring-gray-200">
                        ...
                        >
                            ...
                            >
                                ...
                                <h5 className="text-center">Welcome, The Curry Code 😎</h5>
                                <RowFormInputField
                                    label="mobile"
                                    name="mobile"
